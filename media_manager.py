...
"""
    ...
    def _save_image_metadata(self, image_path: str, prompt: str, style: str, size: str):
        ...
        try:
            ...
            metadata_file = os.path.join(
                self.metadata_dir, f"{os.path.basename(image_path)}.json"
            )
    ...
    def download_image(self, url: str, filename: str = None) -> str | None:
        """
    ...
    def get_character_portrait(
        self, character_name: str, description: str = None
    ) -> str | None:
        """
        ...
        try:
            ...
            return self.generate_image(
                prompt, "character_portrait", "512x512", character_name
            )
    ...
    def get_scene_image(
        self, scene_description: str, character_name: str = None
    ) -> str | None:
        """
        ...
        try:
            ...
            return self.generate_image(
                prompt, "environment", "1024x1024", character_name
            )
    ...
    def get_combat_image(
        self, combat_description: str, character_name: str = None
    ) -> str | None:
        """
    ...
    def get_media_metadata(self, filename: str) -> dict[str, Any] | None:
        """
